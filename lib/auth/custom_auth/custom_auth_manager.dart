...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    fACConsigAuthUserSubject.add(
      FACConsigAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<FACConsigAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  FACConsigAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = FACConsigAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    fACConsigAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
