...
class ConfirmarEmprestimoWidget extends StatefulWidget {
  const ConfirmarEmprestimoWidget({
    super.key,
  ...
  @override
  State<ConfirmarEmprestimoWidget> createState() =>
      _ConfirmarEmprestimoWidgetState();
}

class _ConfirmarEmprestimoWidgetState extends State<ConfirmarEmprestimoWidget> {
  late ConfirmarEmprestimoModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final confirmarEmprestimoSimulaEmprestimoResponse = snapshot.data!;
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '${widget.parcelas}x de ${widget.valor}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                            ...
                                            onPressed: () async {
                                              _model.confirmaEmprestimo =
                                                ...
                                                valorEmprestimo: functions
                                                    .stringDoubleSFomart(widget
                                                        .valorSolicitado),
                                                qtdeParcelas: widget.parcelas,
                                                origem: 'Contratante',
                                              );
