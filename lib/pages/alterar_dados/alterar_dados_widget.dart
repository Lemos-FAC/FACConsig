                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        controller: _model.contTextController,
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                          _model.tipoContaValueController ??=
                                              FormFieldController<String>(
                                        _model.tipoContaValue ??= getJsonField(
                                          FFAppState().contratante.firstOrNull,
                                          r'''$..TipoConta''',
                                        ).toString(),
                                      ),
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.atualizaDados!) {
                                          _model.atualiza = await FACConsigGroup
                                              .atualizaDadosCall
                                              .call(
                                            ...
                                            conta:
                                                _model.contTextController.text,
                                            tipoConta: _model.tipoContaValue,
                                            dataNascimento: _model
                                                .dtaNascimentoTextController
                                                .text,
                                            cpf: functions
                                                .stringTolnt(FFAppState().cpf),
                                            matricula:
                                                functions.cleanAndConvertToInt(
                                                    getJsonField(
                                              FFAppState()
                                                  .contratante
                                                  .firstOrNull,
                                          ...
                                          if ((_model.dadosAtualizados
                                            ...
                                            safeSetState(() {});
                                            safeSetState(() {
                                              _model.ufValueController?.value =
                                                  _model.uf;
                                            });
                                            safeSetState(() {
                                              _model.tipoContaValueController
